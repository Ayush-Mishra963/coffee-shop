...
export default function Gallery() {
  return (
    <section
      id="gallery"
      className="mx-auto max-w-6xl scroll-mt-24 px-6 py-28 md:px-10 md:py-36"
    >
      <motion.div
        variants={fadeUp}
        initial="hidden"
